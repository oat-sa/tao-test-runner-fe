 ...
 */
define(['jquery', 'lodash', 'taoTests/runner/runner', 'taoTests/runner/runnerComponent'], function(
    $,
    _,
    runnerFactory,
    ...
    QUnit.test('module', function(assert) {
        ...
        assert.equal(
            typeof runnerComponentFactory($container, { provider: 'mock' }),
            'object',
            'The runnerComponent factory produces an object'
        );
        assert.notStrictEqual(
            runnerComponentFactory($container, { provider: 'mock' }),
            runnerComponentFactory($container, { provider: 'mock' }),
